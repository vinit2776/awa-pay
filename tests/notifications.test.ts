...
import { accounting, comment, company, department, duplicateCheck, event, headOfAccount, payment, query, request, requestFile, roleGrant, user, vendor } from "../src/db/schema";
