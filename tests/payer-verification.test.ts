...
import { accounting, company, department, duplicateCheck, event, headOfAccount, payment, request, requestFile, roleGrant, user, vendor, vendorBank, vendorDocument } from "../src/db/schema";
